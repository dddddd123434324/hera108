...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        ...
        cwkPQ(6), bossbalrog(1), zak(1), chaoszak(1), horntail(1), chaoshorntail(1), easyht(1), pinkbean(1), nmm_squad(1), vergamot(1), dunas(1), nibergen_squad(1), dunas2(1), core_blaze(1), aufheben(1), cwkpq(10), tokyo_2095(1), vonleon(1), yasunaga(1), scartar(1), cygnus(1);
