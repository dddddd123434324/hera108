...
//        }
                        ...
                        if (GameConstants.isChaosScroll(scrollId.getItemId())) {
                            ...
                            if (Randomizer.nextInt(100) <= chanc || chr.isGM()) {
                                ...
                                if (nEquip.getOwner() == "프로텍트 실드") {
                                    nEquip.setOwner("");
                                    chr.dropMessage(5, "프로텍트 실드의 힘으로 아이템이 파괴되지 않았습니다.");
                                } else {
                                    if (chr.haveItem(2430191)) {
    ...
    public final List<Pair<Integer, String>> getcashItemss() {
    ...
    public final List<Pair<Integer, String>> getFaceList() {
        final List<Pair<Integer, String>> itemPairs = new ArrayList<Pair<Integer, String>>();
        MapleData itemsData;
    ...
    public final List<Pair<Integer, String>> getHairList() {
        final List<Pair<Integer, String>> itemPairs = new ArrayList<Pair<Integer, String>>();
        MapleData itemsData;
