...
//        }
    ...
    public static boolean isNoEnableSkill(int skillid) { //끊어치기
        switch (skillid) {
            case 3121005:
            case 3121004: // 폭풍의 시
            case 3100001: // 파이널 어택
    ...
    private static final java.util.Set<Integer> SP_RESET_PROTECTED_SKILLS = //SP 초기화 주문서 예외 스킬 목록
            new java.util.HashSet<Integer>(java.util.Arrays.asList(
                            14101004, // 플점 나워 2차
                            9001007, // 어드텔
                            9001006, // 팬텀 블로우
                            12101004 // 엘리멘탈 리셋
    ...
    public static boolean isProtectedFromSpReset(int skillId) {
        return SP_RESET_PROTECTED_SKILLS.contains(skillId);
    }
    ...
    public static final java.util.Map<Integer, int[]> ONECLICK_CUBE_OPTION_GROUPS = new java.util.HashMap<Integer, int[]>();

    static {
        ONECLICK_CUBE_OPTION_GROUPS.put(10041, new int[]{10041, 20041, 30041}); // STR%
        ONECLICK_CUBE_OPTION_GROUPS.put(10042, new int[]{10042, 20042, 30042}); // DEX%
        ONECLICK_CUBE_OPTION_GROUPS.put(10043, new int[]{10043, 20043, 30043}); // INT%
        ONECLICK_CUBE_OPTION_GROUPS.put(10044, new int[]{10044, 20044, 30044}); // LUK%
        ...
        ONECLICK_CUBE_OPTION_GROUPS.put(31004, new int[]{31004});             // Hyper Body
    }

    public static boolean oneClickCubeOptionMatches(final int optionKey, final int potentialId) {
        final int[] group = ONECLICK_CUBE_OPTION_GROUPS.get(optionKey);
        if (group == null || potentialId == 0) {
            return false;
        }
        for (int v : group) {
            if (v == potentialId) {
