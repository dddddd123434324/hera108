...
public class DumpItems {
    ...
    private MapleDataProvider item, string = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.WZ_PATH + "/String.wz")), character;
    ...
    public DumpItems(boolean update) throws Exception {
        this.update = update;
        this.item = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.WZ_PATH + "Item.wz"));
        this.character = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.WZ_PATH + "Character.wz"));
...
public void applyPostDumpSlotMax() {
    Connection con = null;
    try {
        ...
        con.commit();
        System.out.println("[PostDump] slotMax fix committed. updatedRows=" + updatedRows);
    } catch (Exception e) {
        System.out.println("[PostDump] slotMax fix failed. Rolling back...");
        try {
